...
- **Built so far:**
  ...
  - **Tests:** 188 Core, 35 App; Core branch coverage 85.2% against the 80% floor.
- **Not built yet:** Files (duplicates, large/old files, disk usage), Apps (uninstaller + leftovers), Startup & performance, Drivers & updates, History, Settings. The nav items for those are in the rail but not yet wired to pages.
